                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach ($estilos as $estilo)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="{{ route('estilos.edit', $estilo) }}" class="text-indigo-600 hover:text-indigo-900">Editar</a>
                                        <form action="{{ route('estilos.destroy', $estilo) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
